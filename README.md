...
1. Click a letter button to make a guess.
2. If the letter is in the word, it will appear in the blanks.
3. If the letter is not in the word, the wrong guess counter increases and the hangman graphic updates.
4. Win by revealing the whole word before you hit the max wrong guesses.
